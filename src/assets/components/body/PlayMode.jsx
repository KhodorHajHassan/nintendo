    ...
    <div>
      <div className="xl:w-7/12 w-full m-auto mb-10 xl:p-0 p-4">
        <div className="flex xl:flex-nowraprap lg:flex-nowrap flex-wrap gap-5">
          <div className="rounded-[1rem] py-8 px-10 bg-gray-100 lg:w-6/12 w-full">
            <p className="font-semibold text-primary mb-4 text-center">
              ESRB rating
            </p>
            <div className="shadow-lg bg-white py-4 px-8 flex items-center gap-2 text-primary rounded-[10px]">
              <img
                src="/E.svg"
                className="w-12"
                alt=""
              ...
              <div>
                ...
                <p className="md:text-sm text-xs text-gray-500">Users Interact</p>
              </div>
            </div>
          </div>
          <div className="rounded-[1rem] py-8 px-10 bg-gray-100 lg:w-6/12 w-full">
            ...
            <div className="grid grid-cols-3 gap-6">
              <div className="flex flex-col gap-4 justify-center items-center ">
                <div className="rounded-[0.75rem] md:w-36 w-20 h-20 bg-primary flex justify-center items-center ">
                    <img 
                      className="w-12"
              ...
              <div className="flex flex-col gap-4 justify-center items-center ">
                <div className="md:w-36 w-20 h-20 rounded-[0.75rem] bg-primary flex justify-center items-center">
                    <img 
                      className="w-12"
